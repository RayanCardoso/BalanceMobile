...
import { installSessionExpiry } from '@/hooks/useSignOut';
import { createQueryClient, QueryProvider } from '@/services/queryClient';
...
export function RootLayout(): React.JSX.Element {
  ...
  return (
    // The drawer (AppNavigator.tsx, expo-router/drawer) is built on react-native-drawer-layout, which
